...
<body>
			...
			<div class="content_text">
				...
				<s:iterator value="blogs" id="blog">
					<div class="wz">
						...
						<h3>
							<a
								href="readBlog.action?blogId=<s:property value = "#blog.blogId"/>"
								target="_blank"><s:property value="#blog.title" />
							</a>
						</h3>
						...
						<dl>
							<!-- 贴图 -->
							<dt>
								<img src=<s:property value = "#blog.imgPath"/> width="200"
									height="123" alt="">
							</dt>
							<dd>
								<!-- 摘要 -->
								...
								<p class="dd_text_2">
									...
									<!-- 阅读量 -->
									<span><s:property value="#blog.readedCount" />
									</span>
									<!-- 日期 -->
									<span class="left sj">时间:<s:property value="#blog.date" />
									</span>
									<!-- <span class="left fl">阅读：<s:property value = "#blog.readedCount"/></span> -->
									<span class="left yd"><a
										href="readBlog.action?blogId=<s:property value = "#blog.blogId"/>"
										target="_blank">阅读全文</a> </span>
									<!--  操作 -->
									<s:if test="#session.user != null">
										<span><a
											href="updateBlogPre.action?blogId=<s:property value = "#blog.blogId"/>">编辑</a>
										</span>
										<span><a
											href="deleteBlogByBlogId?blogId=<s:property value = "#blog.blogId"/>">删除</a>
										</span>
									</s:if>
								<div class="clear"></div>
								</p>
		...
		<div class="right" id="c_right">
           ...
           <div class="clear"></div>
			...
			<div class="link">
				<h2>友情链接</h2>
				<p>
					<a href="http://www.gaosubo.com" target="_blank">王倚晴个人作品</a>
				</p>
			</div>
		</div>
		<!--right end-->
	...
	<div id="footer">
		<p>
			Design by:<a href="http://www.duanliang920.com" target="_blank">少年</a>
			2014-8-9
		</p>
	</div>
	<!--footer end-->

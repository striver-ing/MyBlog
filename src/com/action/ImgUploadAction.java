...
public class ImgUploadAction extends ActionSupport {  
	...
	private String err = "";  
    private String msg;              //è¿????ä¿¡æ??  
    private File fileData;           //ä¸?ä¼????ä»?  
    private String fileDataFileName; //???ä»¶å??  
  
    public String imgUpload() {  
        //??·å??response???requestå¯¹è±¡  
